                        ...
                        <div class="card mt-4 card-bg-fill">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <p class="text-muted">Sign in for continue to Zenvic Remainder.</p>
                                </div>
                    ...
                    <div class="col-lg-12">
                        <div class="text-center">
                            <p class="mb-0 text-muted">&copy;
                                <script>document.write(new Date().getFullYear())</script> ZenvicSoft. Design & Developed <i class="mdi mdi-heart text-danger"></i> by <a href="https://zenvicsoft.com" target="_blank" class="text-danger">ZenvicSoft</a>
                            </p>
                        </div>
                    </div>
                </div>
